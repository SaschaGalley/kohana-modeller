...
class Kohana_Modeller_Form_Element_Text extends Kohana_Modeller_Form_Element_Element
{
	/**
	 *
	...
	{
		if (Kohana::$config->load('modeller.default.activate_redactor'))
		{
		...
		{
			return Form::textarea($this->_column, $this->_model->{$this->_column}, array('id'=>$this->_column.'-editor'));
		}
	}
